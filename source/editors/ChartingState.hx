...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Trigger ScrollingBG', "Should only be used in \"caca timmy\" Stage!"],
		['Disable ScrollingBG', "Should only be used in \"caca timmy\" Stage!"],
		...
		['Change Health Drain', "Value 1: Health Drain Amount."],
		['Toggle Health Drain Can Kill', "1 is on, 2 is off."],
		['Enable Slide', "Sliding man."],
		['Deduct Health Drain', "Value 1: Deduct Drain Amount. (SHOULD ONLY BE USED IN LUA maybe)"],
		['Add Health Drain', "Value 1: Add Drain Amount. (SHOULD ONLY BE USED IN LUA maybe)"],
		['Open Text File', "Value 1: Text File Name"],
		['KonekoDistract', "Value 1: Koneko Distract Type"],
