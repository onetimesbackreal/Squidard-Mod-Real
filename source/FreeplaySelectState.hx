...
class FreeplaySelectState extends MusicBeatState{
    var freeplayCats:Array<String> = ['Squidard', 'Extras', 'Joke Songs', 'Unfinished', 'Old Songs'];
    ...
    override public function update(elapsed:Float){
        ...
        if (controls.ACCEPT){
            switch(curSelected){
                case 0:
                	MusicBeatState.switchState(new SquidFreeplay());
                case 1:
                	MusicBeatState.switchState(new FreeplayCategory2State());
				case 2:
					MusicBeatState.switchState(new JokeSongCategory());
				case 3:
					MusicBeatState.switchState(new UnfinishedSongCategory());
				case 4:
					MusicBeatState.switchState(new OldSongCategory());
            }
        }
